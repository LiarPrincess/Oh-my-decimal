...
public struct Decimal64: DecimalFloatingPoint, DecimalMixin {
  ...
  internal static let fnIsZero = __bid64_isZero
  internal static let fnIsFinite = __bid64_isFinite
  internal static let fnIsInfinite = __bid64_isInf
  internal static let fnIsCanonical = __bid64_isCanonical
  internal static let fnIsNormal = __bid64_isNormal
  internal static let fnIsSubnormal = __bid64_isSubnormal
  internal static let fnIsNaN = __bid64_isNaN
  internal static let fnIsSignalingNaN = __bid64_isSignaling
  internal static let fnIsNegative = __bid64_isSigned

  internal static let fnToString = __bid64_to_string
  internal static let fnFromString = __bid64_from_string

  internal static let fnToDenselyPackedDecimal = __bid_to_dpd64
  internal static let fnFromDenselyPackedDecimal = __bid_dpd_to_bid64

  internal static let fnScaleB = __bid64_scalbln

  internal static var fnToFloat = __bid64_to_binary32
  internal static let fnFromFloat = __binary32_to_bid64
  internal static var fnToDouble = __bid64_to_binary64
  internal static let fnFromDouble = __binary64_to_bid64
#if (arch(i386) || arch(x86_64)) && !os(Windows) && !os(Android)
  internal static var fnToFloat80 = __bid64_to_binary80
  internal static let fnFromFloat80 = __binary80_to_bid64
#endif

  internal static let fnNegate = __bid64_negate
  internal static let fnAbs = __bid64_abs
  internal static let fnAdd = __bid64_add
  internal static let fnSub = __bid64_sub
  internal static let fnMul = __bid64_mul
  internal static let fnDiv = __bid64_div
  internal static let fnRem = __bid64_rem
  internal static let fnPow = __bid64_pow
  internal static let fnSquareRoot = __bid64_sqrt
  internal static let fnFusedMulAdd = __bid64_fma

  internal static let fnIsEqual = __bid64_quiet_equal
  internal static let fnIsLess = __bid64_quiet_less
  internal static let fnIsLessEqual = __bid64_quiet_less_equal
  internal static let fnTotalOrder = __bid64_totalOrder
  internal static let fnMinimum = __bid64_minnum
  internal static let fnMaximum = __bid64_maxnum
  internal static let fnMinimumMagnitude = __bid64_minnum_mag
  internal static let fnMaximumMagnitude = __bid64_maxnum_mag

  internal static let fnFloatingPointClass = __bid64_class

  internal static let fnNextUp = __bid64_nextup
  internal static let fnNextDown = __bid64_nextdown

  internal static let fnQuantize = __bid64_quantize
  internal static let fnSameQuantum = __bid64_sameQuantum
  internal static let fnQuantum = __bid64_quantum

  internal static let fnRoundToNearestOrEven =  __bid64_round_integral_nearest_even
  internal static let fnRoundToNearestOrAwayFromZero =  __bid64_round_integral_nearest_away
  internal static let fnRoundUp =  __bid64_round_integral_positive
  internal static let fnRoundDown =  __bid64_round_integral_negative
  internal static let fnRoundTowardZero =  __bid64_round_integral_zero
  ...
  internal static let maxUnbiasedExponent = 384
