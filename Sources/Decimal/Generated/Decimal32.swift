...
public struct Decimal32: DecimalFloatingPoint, DecimalMixin {
  ...
  internal static let fnIsZero = __bid32_isZero
  internal static let fnIsFinite = __bid32_isFinite
  internal static let fnIsInfinite = __bid32_isInf
  internal static let fnIsCanonical = __bid32_isCanonical
  internal static let fnIsNormal = __bid32_isNormal
  internal static let fnIsSubnormal = __bid32_isSubnormal
  internal static let fnIsNaN = __bid32_isNaN
  internal static let fnIsSignalingNaN = __bid32_isSignaling
  internal static let fnIsNegative = __bid32_isSigned

  internal static let fnToString = __bid32_to_string
  internal static let fnFromString = __bid32_from_string

  internal static let fnToDenselyPackedDecimal = __bid_to_dpd32
  internal static let fnFromDenselyPackedDecimal = __bid_dpd_to_bid32

  internal static let fnScaleB = __bid32_scalbln

  internal static var fnToFloat = __bid32_to_binary32
  internal static let fnFromFloat = __binary32_to_bid32
  internal static var fnToDouble = __bid32_to_binary64
  internal static let fnFromDouble = __binary64_to_bid32
#if (arch(i386) || arch(x86_64)) && !os(Windows) && !os(Android)
  internal static var fnToFloat80 = __bid32_to_binary80
  internal static let fnFromFloat80 = __binary80_to_bid32
#endif

  internal static let fnNegate = __bid32_negate
  internal static let fnAbs = __bid32_abs
  internal static let fnAdd = __bid32_add
  internal static let fnSub = __bid32_sub
  internal static let fnMul = __bid32_mul
  internal static let fnDiv = __bid32_div
  internal static let fnRem = __bid32_rem
  internal static let fnPow = __bid32_pow
  internal static let fnSquareRoot = __bid32_sqrt
  internal static let fnFusedMulAdd = __bid32_fma

  internal static let fnIsEqual = __bid32_quiet_equal
  internal static let fnIsLess = __bid32_quiet_less
  internal static let fnIsLessEqual = __bid32_quiet_less_equal
  internal static let fnTotalOrder = __bid32_totalOrder
  internal static let fnMinimum = __bid32_minnum
  internal static let fnMaximum = __bid32_maxnum
  internal static let fnMinimumMagnitude = __bid32_minnum_mag
  internal static let fnMaximumMagnitude = __bid32_maxnum_mag

  internal static let fnFloatingPointClass = __bid32_class

  internal static let fnNextUp = __bid32_nextup
  internal static let fnNextDown = __bid32_nextdown

  internal static let fnQuantize = __bid32_quantize
  internal static let fnSameQuantum = __bid32_sameQuantum
  internal static let fnQuantum = __bid32_quantum

  internal static let fnRoundToNearestOrEven =  __bid32_round_integral_nearest_even
  internal static let fnRoundToNearestOrAwayFromZero =  __bid32_round_integral_nearest_away
  internal static let fnRoundUp =  __bid32_round_integral_positive
  internal static let fnRoundDown =  __bid32_round_integral_negative
  internal static let fnRoundTowardZero =  __bid32_round_integral_zero
  ...
  internal static let maxUnbiasedExponent = 96
  ...
  public init(
    ...
    var status = ExceptionStatus()
    self = Self._fromDecimal64(value, rounding: rounding, status: &status)
  }
  ...
  public init(
    ...
    var status = ExceptionStatus()
    self = Self._fromDecimal128(value, rounding: rounding, status: &status)
  }
